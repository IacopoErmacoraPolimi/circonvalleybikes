  ...
  <body>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        <br>
        <br>
          <h1 class="header center white-text text-lighten-2">Events</h1>
        <br>
        <br>
      </div>
    </div>
    <div class="parallax"><img src="/images/events2.jpg" alt="Unsplashed background img 1" style="object-fit: cover; height: 200%; width: 80%;"></div>
  </div>
